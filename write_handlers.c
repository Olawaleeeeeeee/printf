 ...
 * @c: character types.
 * @buffer: Buffer array to accomodate printing operations
 * @flags:  Evaluates the active flags.
 * @width: get width.
 ...
 * @is_negative: The lists of variables
 * @ind: character types.
 * @buffer: Buffer array to accomodate printing operation
 * @flags:  Evaluates the active flags
 * @width: get width.
 * @precision: precision specifier
 * @size: Size specifier
...
/**
 * write_pointer - Write a memory address to a variable
